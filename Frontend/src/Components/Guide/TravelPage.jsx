            ...
            <div className="text-center max-w-6xl mx-auto">
              ...
              <div ref={subtitleRef}>
                <p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-4 xs:mb-6 sm:mb-8 leading-relaxed">
                  Essential travel information, preparation tips, and journey
                  planning for your spiritual pilgrimage
                </p>
              </div>
            </div>
          </div>
  ...
  const travelCards = [
    {
      ...
      description:
        "Essential steps to prepare for your journey to the holy lands, from documents to packing.",
      detailedContent: `
    ...
    },
    {
      ...
      description:
        "Booking flights, airport procedures, and transportation options in Saudi Arabia.",
      detailedContent: `
    ...
    },
    {
      ...
      description:
        "Choosing the right hotels and understanding accommodation options near holy sites.",
      detailedContent: `
    ...
    },
    {
      title: "HEALTH & SAFETY",
      description:
        "Staying healthy during your journey and important safety precautions to follow.",
      detailedContent: `
    ...
    },
    {
      ...
      description:
        "Staying connected with family and accessing important information during your trip.",
      detailedContent: `
    ...
    },
    {
      ...
      description:
        "Understanding local customs, traditions, and respectful behavior in Saudi Arabia.",
      detailedContent: `
            <h3>Dress Code</h3>
            <ul>
    ...
    },
    {
      ...
      description:
        "Managing expenses and creating a realistic budget for your spiritual journey.",
      detailedContent: `
