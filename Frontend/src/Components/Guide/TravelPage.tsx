...
interface TravelCard extends GuideCard {
...
function TravelPage() {
                    ...
                    <div className="absolute inset-0 opacity-8 sm:opacity-12 pointer-events-none">
                        {Array.from({ length: 25 }).map((_, i) => (
                            <div
                                ...
                                style={{
                                    top: `${(seededRandom(i * 4) * 100).toFixed(2)}%`,
                                    left: `${(seededRandom(i * 4 + 1) * 100).toFixed(2)}%`,
                                    animationDuration: `${(1.5 + seededRandom(i * 4 + 2) * 2).toFixed(2)}s`,
                                    animationDelay: `${seededRandom(i * 4 + 3).toFixed(2)}s`,
    ...
    const travelCards: TravelCard[] = [
        ...
        `,
            image: travelPreparationImage.src
        },
        {
        ...
        `,
            image: flightTransportImage.src
        },
        {
        ...
        `,
            image: accommodationGuideImage.src
        },
        {
            title: "HEALTH & SAFETY",
        ...
        `,
            image: communicationConnectivityImage.src
        },
        {
        ...
        `,
            image: culturalEtiquetteImage.src
        },
        {
    ...
    const Modal = ({ card, onClose }: ModalProps) => {
        ...
        const handleModalScroll = (e: React.SyntheticEvent) => {
            e.stopPropagation()
        }
    ...
    const renderCards = (cards: TravelCard[]) => {
        return (
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mt-8 text-center pt-8 border-t border-gray-200">
                        <p className="text-gray-500 text-sm">
                            ...
                            <Link
                                href="/packages"
                                className="text-blue-700 hover:text-blue-900 font-medium underline underline-offset-4 transition-colors duration-200"
                            >
