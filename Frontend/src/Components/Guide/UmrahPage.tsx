...
interface UmrahCard extends GuideCard {
  detailedContent: string;
}

function UmrahPage() {
  const [selectedCard, setSelectedCard] = useState<UmrahCard | null>(null);
  ...
  const renderCards = (cards: UmrahCard[]) => {
    return (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8 text-center pt-8 border-t border-gray-200">
            <p className="text-gray-500 text-sm">
              ...
              <Link
                href="/packages"
                className="text-amber-700 hover:text-amber-900 font-medium underline underline-offset-4 transition-colors duration-200"
              >
                View our Umrah packages
              </Link>{" "}
              or{" "}
              <Link
                href="/contact-us"
