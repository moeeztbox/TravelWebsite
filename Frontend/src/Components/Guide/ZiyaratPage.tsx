...
interface ZiyaratSite extends GuideCard {
  id: number;
  highlights: string[];
  bestTime: string;
  prayerReward: string;
...
function ZiyaratPage() {
  ...
  const ziyaratSites: ZiyaratSite[] = [
    ...
    },
    {
      ...
      image: masjidAlQiblataynImage.src,
      significance:
    ...
    },
    {
      ...
      image: masjidAlGhamamaImage.src,
      significance:
  ...
  const ZiyaratSection = ({ site, index }: ZiyaratSectionProps) => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <footer className="bg-gray-100 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8 pt-8 border-t border-gray-700">
            <p className="text-gray-700 text-sm">
              Planning a pilgrimage that includes Ziyarat?{" "}
              <Link
                href="/packages"
