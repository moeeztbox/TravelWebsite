      ...
      >
        <div className="text-center space-y-4 sm:space-y-6">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed px-2">
            Navigate through these essential phases to complete your Hajj
            application with peace and preparation
          </p>
        </div>
      </motion.div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-30 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-12 absolute left-2 md:left-2 w-12 rounded-full bg-gray-900/80 backdrop-blur-sm border border-yellow-500/40 flex items-center justify-center shadow-xl shadow-black/50 hover:scale-110 hover:border-yellow-500/80 transition-all duration-300 cursor-pointer">
  ...
  const phases = [
    {
      ...
      description:
        "Create account, upload documents, and complete your application form",
      details: [
    ...
    },
    {
      ...
      description:
        "Choose your preferred Hajj category and fund your digital wallet",
      details: [
    ...
    },
    {
      ...
      description:
        "Browse service providers and select your ideal Hajj package",
      details: [
    ...
    },
    {
      ...
      description:
        "Finalize your booking, make payment, and review your complete itinerary",
      details: [
    ...
    content: (
      <div className="space-y-3 sm:space-y-4">
        <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-6 bg-gray-900/40 backdrop-blur-sm border border-yellow-500/30 rounded-lg hover:border-yellow-400/50 hover:bg-gray-900/60 transition-all duration-300 hover:transform hover:scale-[1.02] shadow-xl hover:shadow-2xl hover:shadow-yellow-400/10">
          <phase.icon
            className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-yellow-400 flex-shrink-0 mt-1"
            strokeWidth={1.5}
          />
          <div className="flex-1">
            <h4 className="text-yellow-400 font-semibold text-base sm:text-lg md:text-xl mb-2 sm:mb-3">
              {phase.title}
            </h4>
