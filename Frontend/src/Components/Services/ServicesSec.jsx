        ...
        >
            ...
            <div className="w-full lg:w-1/2">
              <div className="rounded-xl overflow-hidden shadow-lg">
                <img
                  ...
                  width={100}
                  height={100}
                  className="w-[850px] h-[595px] object-cover hover:scale-105 transition-transform duration-300"
                />
              </div>
            </div>
          )}
          ...
          >
            ...
            <div className="flex-1">
              <h2 id={`${id}-title`} className="text-3xl font-bold text-gray-900">
                {title}
              </h2>
...
export default function Services() {
  const transportDetails = {
    overview:
      "We provide safe, reliable and comfortable transport across Makkah, Madinah and surrounding ziyarat sites. Our fleet includes private cars, and full-size AC coaches. Drivers are experienced, licensed, and briefed on religious sensitivities.",
    highlights: [
    ...
    sampleItinerary:
      "Day 1: Arrival at Jeddah — transfer to Makkah hotel. Day 2: Visit Haram and local ziyarat. Day 3: Transfer to Madinah with stops at significant sites.",
    faqs: [
      {
              ...
              >
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  ...
                  <a href={`#${s.id}`} className="inline-block">
                    <Button size="lg" variant="secondary">Learn more about {s.title}</Button>
                  </a>
                </div>
              </Section>
            ))}
