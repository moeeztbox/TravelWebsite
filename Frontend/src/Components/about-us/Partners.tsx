        ...
        {[...partners, ...partners].map((partner, idx) => (
          ...
          >
            <div className="relative h-20 w-40">
              {/* Partner logos come from 10 disparate third-party hosts we
                  don't control — `unoptimized` renders them as-is (same as
                  the plain <img> this replaces) without adding any of those
                  hosts to next.config.ts's image allowlist. */}
              <Image
                src={partner.img}
