...
const ContactUsHeroSection = () => {
  ...
  return (
    <section
      style={{
        backgroundImage: `linear-gradient(135deg, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.75) 50%, rgba(0,0,0,0.9) 100%), url(${AboutHeroImage.src})`,
      ...
      <div className="absolute inset-0 opacity-30 pointer-events-none z-2">
        {Array.from({ length: 18 }).map((_, i) => (
          <div
            ...
            style={{
              top: `${(seededRandom(i * 4) * 90 + 5).toFixed(2)}%`,
              left: `${(seededRandom(i * 4 + 1) * 90 + 5).toFixed(2)}%`,
