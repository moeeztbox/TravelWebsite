...
function newsletterErrorMessage(err: unknown, fallback: string): string {
...
export default function Footer() {
  ...
  const handleSubscribe = async (
    ...
    try {
      ...
      setNote(newsletterErrorMessage(err, "Could not subscribe"));
    } finally {
      setBusy(false);
    }
  };
  ...
  const handleUnsubscribe = async (
    ...
    try {
      ...
      setNote(newsletterErrorMessage(err, "Could not unsubscribe"));
    } finally {
      setBusy(false);
    }
  };
