...
export default function NavbarDemo() {
  ...
  const navItems: NavItem[] = [
    ...
    { name: "Policies", link: "/coming-soon" },
    {
      name: "Guide",
      link: "/guidance",
      subItems: [
                  ...
                  >
                    {avatarUrl ? (
                      <div className="relative w-8 h-8 sm:w-9 sm:h-9">
                        {/* Avatar comes from Dicebear as an SVG — `unoptimized`
                            renders it as-is without needing dangerouslyAllowSVG. */}
                        <Image
                          src={avatarUrl}
                          alt="Avatar"
                          fill
                          unoptimized
                          className="rounded-full bg-white ring-1 ring-amber-200 object-cover"
                        />
                      </div>
                    ) : (
                      <UserCircle
                ...
                <div className="relative">
                  <button
                    ...
                    className={[
                      ...
                      mobileAccountOpen || pathname.startsWith("/admin")
