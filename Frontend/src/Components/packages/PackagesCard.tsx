...
interface PackageDialogProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onBookPackage: () => Promise<void> | void;
  booking: boolean;
}

function PackageDialog({ pkg, isOpen, onClose, onBookPackage, booking }: PackageDialogProps) {
        ...
        >
          ...
          >
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="relative w-full sm:w-48 h-36 sm:h-40 rounded-2xl overflow-hidden bg-stone-100 border border-stone-200 shrink-0">
                {/* pkg.image is an admin-entered URL — can point to any host,
                    so `unoptimized` renders it as-is rather than requiring an
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  ...
                  onClose?.();
                  router.push("/login?from=%2Fpackages");
                }}
                style={{
                  padding: "10px 16px",
                  borderRadius: "12px",
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: "14px", color: "#78716c", margin: "8px 0 0" }}>
                ...
                {" "}Your request will appear on your dashboard for admin approval.
              </p>
            </div>
            <div
              style={{
