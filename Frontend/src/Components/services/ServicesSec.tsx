...
import transportImage from "../../assets/Images/Services/Luxury_pilgrim_transport_bus_3dadbe50.png";
import visaImage from "../../assets/Images/Services/Visa_documents_professional_photography_a0d3bfb0.png";
import ticketImage from "../../assets/Images/Services/Airline_tickets_and_boarding_2ed6da07.png";
import hotelsImage from "../../assets/Images/Services/Luxury_hotel_room_interior_1b56bb77.png";
import ziyaratImage from "../../assets/Images/Services/Ziyarat_historical_Islamic_sites_b37dcfef.png";
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <div
          className={`flex flex-col ${imagePosition === "right" ? "lg:flex-row" : "lg:flex-row-reverse"} items-start gap-8 lg:gap-12`}
        >
          {/* Image Section */}
          {imageUrl && (
          ...
          {/* Content Section */}
          <div
            className={`w-full ${imageUrl ? "lg:w-1/2" : "max-w-4xl"} flex items-start gap-6`}
          >
...
function FAQ({ faqs }: { faqs: ServiceFaqItem[] }) {
  return (
...
export default function Services() {
  ...
  const transportDetails: ServiceDetail = {
    overview:
    ...
    imageUrl: transportImage.src,
  };

  const visaDetails: ServiceDetail = {
    overview:
    ...
    faqs: [
      {
        ...
        a: "Passport with 6+ months validity, passport photos, vaccination certificates (if required), and previous travel history where applicable.",
      },
      {
        q: "Can you handle group visas?",
        a: "Yes — we have processes to handle groups with a single coordinator for smoother applications.",
      },
    ],
    imageUrl: visaImage.src,
  };

  const ticketDetails: ServiceDetail = {
    overview:
    ...
    highlights: [
      "Multi-city routing (e.g., Jeddah → Makkah → Madinah → Home)",
      "Flexible/changeable fares",
    ...
    faqs: [
      {
        q: "Can I reserve before payment?",
        a: "We can hold limited reservations for a short window depending on airline rules; full payment is required to ticket.",
      },
      {
        q: "Do you include travel insurance?",
        a: "We offer insurance as an add-on during booking and can recommend plans suited for pilgrims.",
      },
    ],
    imageUrl: ticketImage.src,
  };

  const hotelsDetails: ServiceDetail = {
    overview:
    ...
    highlights: [
      "Near‑Haram options",
      "Breakfast and half-board choices",
      "Group & family rooms",
      "Special requests (adjacent rooms, baby cots)",
    ],
    sample:
      "Example: 3 nights in Makkah (near Haram) + 3 nights in Madinah (near Prophet's Mosque) with daily breakfast and optional guided ziyarat tours.",
    faqs: [
      {
        q: "How close are the hotels to the Haram?",
        a: "We categorize hotels by walking distance: within 3 minutes, 5–10 minutes, and shuttle-access hotels. You can filter by walking time during booking.",
      },
      {
        q: "Are rooms halal‑certified / family friendly?",
        a: "All partner hotels are family-friendly and respect religious practices; we confirm specifics at booking.",
      },
    ],
    imageUrl: hotelsImage.src,
  };

  const ziawratDetails: ServiceDetail = {
    overview:
    ...
    highlights: [
      ...
      "Combination with transport and meals",
    ],
    sampleStops:
    ...
    faqs: [
      {
        q: "Can we customize the ziyarat schedule?",
        a: "Yes — we design bespoke schedules according to your religious preferences and energy levels.",
      },
      {
        q: "Are English-speaking guides available?",
        a: "Yes — we have multilingual guides; specify language requirements at booking.",
      },
    ],
    imageUrl: ziyaratImage.src,
  };
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-5xl font-extrabold text-white">
              Hassle‑free Haj &amp; Umrah Services
            </h1>
            <p className="mt-4 text-yellow-100/90 text-lg">
              Visas, flights, hotels, transport and guided ziyarat — planned
              with care so you can focus on your ibadah.
            </p>
              ...
              >
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  <button
                    ...
                    onClick={(e) => {
                      ...
                      e.stopPropagation();
                      if (s.id === "ziawrat") {
                        router.push("/ziyarat-guide");
                        return;
                      }
                      router.push(
                        "/contact-us?scrollTo=inquiry-form-section&form=inquiry",
                      );
                    }}
                ...
                <div className="mt-12 border-t pt-8">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    <span className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-1 text-sm text-gray-700 ring-1 ring-gray-100">
                      <Plane className="h-4 w-4 text-gray-500" /> Flight
                      Assistance
                    </span>
                    <span className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-1 text-sm text-gray-700 ring-1 ring-gray-100">
                      <Landmark className="h-4 w-4 text-gray-500" /> Guided
                      Ziyarat
                    </span>
                  </div>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                <div>
                  ...
                  <p className="mt-2 text-yellow-100/90">
                    Tell us your travel window and preferences — we&apos;ll craft the
                    perfect Haj/Umrah package.
                  </p>
                </div>
