...
import { Filter, Loader2, CheckCircle2, XCircle, X } from "lucide-react";
...
export default function AdminCustomPackages() {
  ...
  const openApprove = (r) => {
    setEditFor(r);
    setExtraAmount(r.adminExtra?.amount != null ? String(r.adminExtra.amount) : "");
    setTotalAmount(r.adminTotal?.amount != null ? String(r.adminTotal.amount) : "");
  ...
  return (
    <AdminLayout
      ...
      subtitle="Review custom package requests. Approve and set extra/final amount."
      headerRight={
