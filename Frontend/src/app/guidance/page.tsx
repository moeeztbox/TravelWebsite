...
export const metadata: Metadata = pageMetadata({
  title: "Travel Guides",
  description:
    "Expert guidance for Umrah, Ziyarat, and travel preparation to help make your pilgrimage journey seamless.",
  path: "/guidance",
})

type GuideColor = 'blue' | 'green' | 'amber'
  ...
  const guideCards: GuideCardData[] = [
    {
      ...
      icon: "🕋",
      color: "blue",
      background: "/images/guide/umrah-guide-card.jpg"
    },
    {
      title: "Ziyarat Guide",
      ...
      icon: "🕌",
      color: "green",
      background: "/images/guide/ziyarat-guide-card.jpg"
    },
    {
      title: "Travel Guide",
      ...
      icon: "✈️",
      color: "amber",
      background: "/images/guide/travel-guide-card.jpg"
    }
  ]

  const colorStyles: Record<GuideColor, ColorStyle> = {
    blue: {
