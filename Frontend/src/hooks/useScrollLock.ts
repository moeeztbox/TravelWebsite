...
interface PrevHtmlStyle {
  overflow?: string;
  overscrollBehavior?: string;
}

let prevBody: PrevBodyStyle = {};
let prevHtml: PrevHtmlStyle = {};
let pendingScrollY: number | null = null;
let pendingReleaseRaf: number | null = null;
...
export function getScrollLockState(): ScrollLockState {
